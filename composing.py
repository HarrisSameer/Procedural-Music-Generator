...
class Chord(Enum):
    ...
    """
    MAJOR = [0, 4, 7]
    MAJOR_1ST_INV = [4, 7, 12]
    MAJOR_2ND_INV = [7, 12, 16]
    MAJOR_WITH_INV = [0, 4, 7, 12, 16]
    MINOR = [0, 3, 7]
    MINOR_1ST_INV = [3, 7, 12]
    MINOR_2ND_INV = [7, 12, 15]
    MINOR_WITH_INV = [0, 3, 7, 12, 15]
    AUGMENTED = [0, 4, 8]
    DIMINISHED = [0, 3, 6]
    SUS_2 = [0, 1, 4]
    SUS_4 = [0, 3, 4]
...
class Song:
    ...
    def play(self):
        ...
        try:
            ...
            play_midi.play_midi(tmpfilename)
        finally:
